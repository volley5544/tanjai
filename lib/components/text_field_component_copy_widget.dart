...
import 'text_field_component_copy_model.dart';
export 'text_field_component_copy_model.dart';

class TextFieldComponentCopyWidget extends StatefulWidget {
  const TextFieldComponentCopyWidget({
    super.key,
    required this.title,
  ...
  @override
  State<TextFieldComponentCopyWidget> createState() =>
      _TextFieldComponentCopyWidgetState();
}

class _TextFieldComponentCopyWidgetState
    extends State<TextFieldComponentCopyWidget> {
  late TextFieldComponentCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TextFieldComponentCopyModel());
