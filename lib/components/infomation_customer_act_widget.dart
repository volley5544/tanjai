...
import 'infomation_customer_act_model.dart';
export 'infomation_customer_act_model.dart';

class InfomationCustomerActWidget extends StatefulWidget {
  const InfomationCustomerActWidget({super.key});

  @override
  State<InfomationCustomerActWidget> createState() =>
      _InfomationCustomerActWidgetState();
}

class _InfomationCustomerActWidgetState
    extends State<InfomationCustomerActWidget> with TickerProviderStateMixin {
  late InfomationCustomerActModel _model;
