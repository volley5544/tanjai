...
import 'infomation_customer_model.dart';
export 'infomation_customer_model.dart';

class InfomationCustomerWidget extends StatefulWidget {
  const InfomationCustomerWidget({super.key});

  @override
  State<InfomationCustomerWidget> createState() =>
      _InfomationCustomerWidgetState();
}

class _InfomationCustomerWidgetState extends State<InfomationCustomerWidget>
    with TickerProviderStateMixin {
  late InfomationCustomerModel _model;
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    '${functions.showNumberWithComma(FFAppState().appDetailNew.discountOther)} บาท',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          font: GoogleFonts.notoSansThai(
                          ...
                          if ((FFAppState().insuranceInfoActFlag == '1') ||
                              (FFAppState().appDetailNew.discountFlg == '1'))
                            Row(
                              mainAxisSize: MainAxisSize.max,
                              children: [
                                Container(
                                ...
                                children: [
                                  ...
                                  if (false)
                                    Container(
                                      ...
                                      child: Text(
                                        '(${FFAppState().nonePackageWorkType}${FFAppState().insuranceinfoActType == 'MC' ? '_' : ')'}${FFAppState().insuranceinfoActType == 'MC' ? 'มอเตอร์ไซค์' : ''}${FFAppState().insuranceinfoActType == 'MC' ? ')' : ''}',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.notoSansThai(
