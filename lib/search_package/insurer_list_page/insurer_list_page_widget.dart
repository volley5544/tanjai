    ...
    return GestureDetector(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          ...
          body: SafeArea(
            top: true,
            child: StreamBuilder<List<InsurerConfig2Record>>(
                                  ...
                                  children: [
                                    if (((TelePackageSearchAPICall.total(
                                      ...
                                      Expanded(
                                        child: Builder(
                                          builder: (context) {
                                            final listinsurance = FFAppState()
                                                .searchFullName
                                                .toList();
                                                  ...
                                                  visible: (FFAppState()
                                                      ...
                                                      ? ((FFAppState()
                                                          ...
                                                          (FFAppState().filterCoverTypeList.length > 0
                                                              ? FFAppState()
                                                                  .filterCoverTypeList
                                                                  .contains(FFAppState().searchCoverType[listinsuranceIndex])
                                                              : true) &&
                                                          (FFAppState().filterGarageTypeList.length > 0 ? FFAppState().filterGarageTypeList.contains(FFAppState().searchGarageType[listinsuranceIndex]) : true))
                                                      : true,
                                                  child: Padding(
                                                    padding:
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                ...
                                                                FFAppState()
                                                                  ...
                                                                  listinsuranceIndex,
                                                                  (_) => FFAppState()
                                                                              .selectInsurerList[listinsuranceIndex] ==
                                                                          true
                                                                      ? false
                                                                      : true,
                                                                );
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            Visibility(
                                                                          visible:
                                                                              FFAppState().selectInsurerList[listinsuranceIndex],
                                                                          child:
                                                                              Icon(
                                                                            Icons.check,
                                                                            color:
                            ...
                            if ((((TelePackageSearchAPICall.total(
                                    ...
                                    ((TelePackageSearchMCAPICall.total(
                                        ...
                                        ((_model.packageAPIMCOutput
                                                ...
                                                200) ==
                                            200))) &&
                                (functions.countTrueInBoolList(FFAppState()
                                        .selectInsurerList
                                        .toList())! >=
                                    2))
                              Padding(
