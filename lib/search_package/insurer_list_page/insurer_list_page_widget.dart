                                                                                        ...
                                                                                        onPressed: () async {
                                                                                          context.pushNamed(
                                                                                            ...
                                                                                            queryParameters: {
                                                                                              ...
                                                                                              'grossTotalDiscount': serializeParam(
                                                                                                FFAppState().searchGrosstotaldiscount.elementAtOrNull(listinsuranceIndex),
                                                                                                ParamType.String,
                                                                                              ),
                                                                                              'discountOther': serializeParam(
                                                                                                FFAppState().searchDiscountother.elementAtOrNull(listinsuranceIndex),
                                                                                                ParamType.String,
                                                                                              ),
