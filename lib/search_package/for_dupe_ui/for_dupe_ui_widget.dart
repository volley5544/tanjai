...
import 'for_dupe_ui_model.dart';
export 'for_dupe_ui_model.dart';
...
class _ForDupeUiWidgetState extends State<ForDupeUiWidget> {
  late ForDupeUiModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ForDupeUiModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'forDupeUi'});
