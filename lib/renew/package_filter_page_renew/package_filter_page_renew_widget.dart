...
import 'package_filter_page_renew_model.dart';
export 'package_filter_page_renew_model.dart';

class PackageFilterPageRenewWidget extends StatefulWidget {
  const PackageFilterPageRenewWidget({
    super.key,
  ...
  final List<PackageStruct>? package;

  static String routeName = 'PackageFilterPageRenew';
  static String routePath = 'PackageFilterRenew';

  @override
  State<PackageFilterPageRenewWidget> createState() =>
      _PackageFilterPageRenewWidgetState();
}

class _PackageFilterPageRenewWidgetState
    extends State<PackageFilterPageRenewWidget> with TickerProviderStateMixin {
  late PackageFilterPageRenewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PackageFilterPageRenewModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'PackageFilterPageRenew'});
    // On page load action.
                                        ...
                                        context.pushNamed(
                                          ...
                                          queryParameters: {
                                            ...
                                            'dataList': serializeParam(
                                              functions.removeDupeInList(widget!
                                                  .package
                                                  ?.map((e) => e.serialName)
                                                  .toList()
                                                  ?.toList()),
