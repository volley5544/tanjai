...
import 'renew_save_history_model.dart';
export 'renew_save_history_model.dart';

class RenewSaveHistoryWidget extends StatefulWidget {
  const RenewSaveHistoryWidget({
    super.key,
    required this.title,
    required this.name,
...
class _RenewSaveHistoryWidgetState extends State<RenewSaveHistoryWidget> {
  late RenewSaveHistoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RenewSaveHistoryModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'renewSaveHistory'});
    // On page load action.
