...
import 'renew_basic_info_page_model.dart';
export 'renew_basic_info_page_model.dart';

class RenewBasicInfoPageWidget extends StatefulWidget {
  const RenewBasicInfoPageWidget({
    super.key,
  ...
  State<RenewBasicInfoPageWidget> createState() =>
      _RenewBasicInfoPageWidgetState();
}

class _RenewBasicInfoPageWidgetState extends State<RenewBasicInfoPageWidget>
    with TickerProviderStateMixin {
  late RenewBasicInfoPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RenewBasicInfoPageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'RenewBasicInfoPage'});
    // On page load action.
