...
import 'information_customer_model.dart';
export 'information_customer_model.dart';
...
class _InformationCustomerWidgetState extends State<InformationCustomerWidget> {
  late InformationCustomerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InformationCustomerModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'InformationCustomer'});
