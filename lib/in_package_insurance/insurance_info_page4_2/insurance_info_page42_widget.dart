  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
        ...
        (_model.ibsDetailAPIOutput?.jsonBody ?? ''),
              ...
              .elementAtOrNull(functions.getIndexOfIntList(
                  functions
                      ...
                      .toList(),
                  widget!.leadDetailId)))!;
      FFAppState().InsuranceInfoWorkType =
          '${IbsApplicationsDetailCall.worktype(
        (_model.ibsDetailAPIOutput?.jsonBody ?? ''),
      )}';
      ...
      if (FFAppState().insuranceInfoPage4PaymentType == 'จ่ายเต็ม') {
        ...
        safeSetState(() {
          _model.discountOtherTextController?.text = functions
              .showNumberWithComma(FFAppState().appDetailNew.discountOther)!;
        });
        Navigator.pop(context);
      } else {
        _model.calInstallmentAPIOutput = await IbsCalculateInstallmentCall.call(
          ...
          workType: FFAppState().InsuranceInfoWorkType,
        );
    ...
    _model.discountOtherTextController ??= TextEditingController(
        text: functions
            .showNumberWithComma(FFAppState().appDetailNew.discountOther));
    _model.discountOtherFocusNode ??= FocusNode();
                                      ...
                                      child: Container(
                                        ...
                                        child: Align(
                                          ...
                                          child: Padding(
                                            ...
                                            child: TextFormField(
                                              controller: _model
                                                  .discountOtherTextController,
                                              focusNode:
                                                  _model.discountOtherFocusNode,
                                              autofocus: false,
                                              readOnly: true,
                                              obscureText: false,
                                              decoration: InputDecoration(
                                              ...
                                              validator: _model
                                                  .discountOtherTextControllerValidator
                                                  .asValidator(context),
                                            ),
                                          ),
                                        ),
                                                                ...
                                                                builder:
                                                                  ...
                                                                  return WebViewAware(
                                                                    child:
                                                                        AlertDialog(
                                                                      content: Text(
                                                                          'บังคับเลือกจำนวนงวดที่ต้องการจ่ายล่วงหน้า'),
                                                                      actions: [
                                                                        TextButton(
                                                                          onPressed: () =>
                                                                              Navigator.pop(alertDialogContext),
