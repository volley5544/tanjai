...
import 'battery_infomation_form_component_model.dart';
export 'battery_infomation_form_component_model.dart';

class BatteryInfomationFormComponentWidget extends StatefulWidget {
  const BatteryInfomationFormComponentWidget({
    super.key,
    required this.index,
  ...
  @override
  State<BatteryInfomationFormComponentWidget> createState() =>
      _BatteryInfomationFormComponentWidgetState();
}

class _BatteryInfomationFormComponentWidgetState
    extends State<BatteryInfomationFormComponentWidget> {
  late BatteryInfomationFormComponentModel _model;
      ...
      children: [
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                'แบตเตอร์รีลูกที่${((widget!.index!) + 1).toString()}',
                                ...
                                child: Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      focusNode:
                                          _model.batteryPriceTextfieldFocusNode,
                                      autofocus: false,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelStyle: FlutterFlowTheme.of(context)
