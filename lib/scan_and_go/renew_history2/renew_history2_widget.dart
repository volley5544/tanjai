...
import 'renew_history2_model.dart';
export 'renew_history2_model.dart';

class RenewHistory2Widget extends StatefulWidget {
  const RenewHistory2Widget({
    super.key,
  ...
  static String routeName = 'renewHistory2';
  static String routePath = 'renewHistory2';

  @override
  State<RenewHistory2Widget> createState() => _RenewHistory2WidgetState();
}

class _RenewHistory2WidgetState extends State<RenewHistory2Widget> {
  late RenewHistory2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RenewHistory2Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'renewHistory2'});
    // On page load action.
