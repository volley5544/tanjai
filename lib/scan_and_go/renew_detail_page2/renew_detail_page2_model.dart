...
import '/index.dart';
import 'renew_detail_page2_widget.dart' show RenewDetailPage2Widget;
...
class RenewDetailPage2Model extends FlutterFlowModel<RenewDetailPage2Widget> {
  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Backend Call - API (getDataRenew)] action in renewDetailPage2 widget.
