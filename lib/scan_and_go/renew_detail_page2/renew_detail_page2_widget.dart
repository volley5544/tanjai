...
import 'renew_detail_page2_model.dart';
export 'renew_detail_page2_model.dart';

class RenewDetailPage2Widget extends StatefulWidget {
  const RenewDetailPage2Widget({
    super.key,
  ...
  static String routeName = 'renewDetailPage2';
  static String routePath = 'renewDetailPage2';

  @override
  State<RenewDetailPage2Widget> createState() => _RenewDetailPage2WidgetState();
}

class _RenewDetailPage2WidgetState extends State<RenewDetailPage2Widget> {
  late RenewDetailPage2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RenewDetailPage2Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'renewDetailPage2'});
    // On page load action.
