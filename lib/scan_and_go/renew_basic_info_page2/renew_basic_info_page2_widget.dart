...
import 'renew_basic_info_page2_model.dart';
export 'renew_basic_info_page2_model.dart';

class RenewBasicInfoPage2Widget extends StatefulWidget {
  const RenewBasicInfoPage2Widget({
    super.key,
    required this.quotationId,
    required this.leadDetailId,
  });

  final String? quotationId;
  final int? leadDetailId;

  static String routeName = 'RenewBasicInfoPage2';
  static String routePath = 'RenewBasicInfoPage2';

  @override
  State<RenewBasicInfoPage2Widget> createState() =>
      _RenewBasicInfoPage2WidgetState();
}

class _RenewBasicInfoPage2WidgetState extends State<RenewBasicInfoPage2Widget>
    with TickerProviderStateMixin {
  late RenewBasicInfoPage2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RenewBasicInfoPage2Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'RenewBasicInfoPage2'});
    // On page load action.
        ...
        await showDialog(
          ...
          builder: (alertDialogContext) {
            return WebViewAware(
              child: AlertDialog(
                content: Text(
                    'พบข้อผิดพลาด (${(_model.getAppDetailAPIOutput?.statusCode ?? 200).toString()})'),
                actions: [
                  TextButton(
                    onPressed: () => Navigator.pop(alertDialogContext),
                    child: Text('Ok'),
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          ...
                                                          if (selectedMedia !=
                                                              ...
                                                              selectedMedia.every((m) =>
                                                                  validateFileFormat(
                                                                      ...
                                                                      context))) {
                                                            safeSetState(() =>
                                                                _model.isDataUploading_uploaded03212 =
                                                                    true);
                                                            ...
                                                            if (selectedUploadedFiles
                                                                ...
                                                                downloadUrls
                                                                    ...
                                                                    selectedMedia
                                                                        .length) {
                                                              safeSetState(() {
                                                                _model.uploadedLocalFile_uploaded03212 =
                                                                    selectedUploadedFiles
                                                                        .first;
                                                                _model.uploadedFileUrl_uploaded03212 =
                                                                    downloadUrls
                                                                        .first;
                                                              });
                                                            } else {
                                                          ...
                                                          FFAppState()
                                                              ...
                                                              _model
                                                                  .uploadedFileUrl_uploaded03212;
                                                          safeSetState(() {});
                                                          if (_model.uploadedFileUrl_uploaded03212 !=
                                                                  null &&
                                                              _model.uploadedFileUrl_uploaded03212 !=
                                                                  '') {
                                                            ScaffoldMessenger
