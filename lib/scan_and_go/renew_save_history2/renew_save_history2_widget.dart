...
import 'renew_save_history2_model.dart';
export 'renew_save_history2_model.dart';

class RenewSaveHistory2Widget extends StatefulWidget {
  const RenewSaveHistory2Widget({
    super.key,
    required this.title,
    required this.name,
  ...
  static String routeName = 'renewSaveHistory2';
  static String routePath = 'renewSave2';

  @override
  State<RenewSaveHistory2Widget> createState() =>
      _RenewSaveHistory2WidgetState();
}

class _RenewSaveHistory2WidgetState extends State<RenewSaveHistory2Widget> {
  late RenewSaveHistory2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RenewSaveHistory2Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'renewSaveHistory2'});
    // On page load action.
        ...
        await showDialog(
          ...
          builder: (alertDialogContext) {
            return WebViewAware(
              child: AlertDialog(
                content: Text(
                    'พบข้อผิดพลาด (${(_model.masterAPIOutput?.statusCode ?? 200).toString()})'),
                actions: [
                  TextButton(
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: FlutterFlowDropDown<String>(
                                          controller: _model
                                                  .dropDownMainValueController ??=
                                              FormFieldController<String>(null),
                                          options: RenewMasterGetCallStatusCall
                                              .callstatus(
                                          ...
                                          Padding(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                ...
                                                _model.callStatusSaveAPIOutput =
                                                    await RenewCallStatusSaveCall
                                                        .call(
                                                  token:
                                                  ...
                                                  await showDialog(
                                                    ...
                                                    builder:
                                                      ...
                                                      return WebViewAware(
                                                        child: AlertDialog(
                                                          content: Text(
                                                              'พบข้อผิดพลาด (${(_model.callStatusSaveAPIOutput?.statusCode ?? 200).toString()})'),
                                                          actions: [
                                                            TextButton(
                                                              onPressed: () =>
                                                                  Navigator.pop(
                                                  ...
                                                  await showDialog(
                                                    ...
                                                    builder:
                                                      ...
                                                      return WebViewAware(
                                                        child: AlertDialog(
                                                          content: Text(
                                                              '${RenewCallStatusSaveCall.messageLayer1(
                                                            (_model.callStatusSaveAPIOutput
                                                                    ?.jsonBody ??
                                                                ''),
                                                          )}'),
