...
import '/index.dart';
import 'dart:async';
import 'renew_search_all_pool_page2_widget.dart'
...
class RenewSearchAllPoolPage2Model
    extends FlutterFlowModel<RenewSearchAllPoolPage2Widget> {
  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Custom Action - getBuildVersion1] action in renewSearchAllPoolPage2 widget.
  String? getBuildVersion;
  // Stores action output result for [Custom Action - getBuildNumber] action in renewSearchAllPoolPage2 widget.
  int? deviceBuildNumber;
  // Stores action output result for [Firestore Query - Query a collection] action in renewSearchAllPoolPage2 widget.
