...
import 'renew_search_all_pool_page2_model.dart';
export 'renew_search_all_pool_page2_model.dart';

class RenewSearchAllPoolPage2Widget extends StatefulWidget {
  const RenewSearchAllPoolPage2Widget({super.key});

  static String routeName = 'renewSearchAllPoolPage2';
  static String routePath = 'renewSearchAllPoolPage2';

  @override
  State<RenewSearchAllPoolPage2Widget> createState() =>
      _RenewSearchAllPoolPage2WidgetState();
}

class _RenewSearchAllPoolPage2WidgetState
    extends State<RenewSearchAllPoolPage2Widget> with TickerProviderStateMixin {
  late RenewSearchAllPoolPage2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RenewSearchAllPoolPage2Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'renewSearchAllPoolPage2'});
    // On page load action.
        ...
        body: SafeArea(
          ...
          child: StreamBuilder<List<AuthorizationRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              List<AuthorizationRecord> tabBarAuthorizationRecordList =
                  snapshot.data!;
              // Return an empty Container when the item does not exist.
              if (snapshot.data!.isEmpty) {
                return Container();
              }
              final tabBarAuthorizationRecord =
                  tabBarAuthorizationRecordList.isNotEmpty
                      ? tabBarAuthorizationRecordList.first
                      : null;
                    ...
                    child: TabBarView(
                      ...
                      children: [
                                                                              ...
                                                                              return Padding(
                                                                                ...
                                                                                child: FFButtonWidget(
                                                                                  onPressed: () async {
                                                                                    ...
                                                                                    FFAppState().nonePackageTruckCurrentPrice = 'กรุณากรอกราคาซื้อขายปัจจุบัน';
                                                                                    ...
                                                                                    FFAppState().nonePackageOldVmiExpDate = 'กรุณาเลือกวันที่หมดอายุประกันเดิม';
                                                                                    ...
                                                                                    FFAppState().nonePackageIdCardWatermarkUploadedCheck = false;
                                                                                    safeSetState(() {});
                                                                                    FFAppState().nonePackageVehicleType = FFAppState().searchPackageCheckFilled.firstOrNull! ? FFAppState().insuranceVehicleTypeDropDown : FFAppState().nonePackageVehicleType;
                                                                                    FFAppState().nonePackageBrandName = FFAppState().searchPackageCheckFilled.elementAtOrNull(1)! ? FFAppState().insuranceBasicBrandName : FFAppState().nonePackageBrandName;
                                                                                    FFAppState().nonePackageBrandId = FFAppState().searchPackageCheckFilled.elementAtOrNull(1)! ? FFAppState().insuranceBasicBrandId : FFAppState().nonePackageBrandId;
                                                                                    FFAppState().nonePackageModelName = FFAppState().searchPackageCheckFilled.elementAtOrNull(2)! ? FFAppState().insuranceBasicModelName : FFAppState().nonePackageModelName;
                                                                                    FFAppState().nonePackageModelCode = FFAppState().searchPackageCheckFilled.elementAtOrNull(2)! ? FFAppState().insuranceBasicModelId : FFAppState().nonePackageModelCode;
                                                                                    FFAppState().nonePackageYear = FFAppState().searchPackageCheckFilled.elementAtOrNull(3)! ? FFAppState().insuranceBasicYear : FFAppState().nonePackageYear;
                                                                                    FFAppState().nonePackageUsedTypeId = FFAppState().searchPackageCheckFilled.elementAtOrNull(4)! ? FFAppState().insuranceBasicVehicleUsedTypeId : FFAppState().nonePackageUsedTypeId;
                                                                                    FFAppState().nonePackageUsedTypeCode = FFAppState().searchPackageCheckFilled.elementAtOrNull(4)! ? FFAppState().insuranceBasicVehicleUsedTypeCode : FFAppState().nonePackageUsedTypeCode;
                                                                                    FFAppState().nonePackageUsedTypeName = FFAppState().searchPackageCheckFilled.elementAtOrNull(4)! ? FFAppState().insuranceBasicVehicleUsedTypeName : FFAppState().nonePackageUsedTypeName;
                                                                                    FFAppState().nonePackageIsBrandSelect = FFAppState().searchPackageCheckFilled.elementAtOrNull(1)!;
                                                                                    FFAppState().nonePackageSearchModelList = FFAppState().searchPackageCheckFilled.elementAtOrNull(1)! ? FFAppState().insuranceBasicModelNameList : FFAppState().nonePackageSearchModelList.toList().cast<String>();
                                                                                    FFAppState().nonePackageSearchModelIdList = FFAppState().searchPackageCheckFilled.elementAtOrNull(1)! ? FFAppState().insuranceBasicModelIdList : FFAppState().nonePackageSearchModelIdList.toList().cast<String>();
                                                                                    safeSetState(() {});
                                                                                    FFAppState().nonePackageOldVmiExpDate = FFAppState().insuranceBasicOldVmiExpDate;
                                                                                    safeSetState(() {});
                                                                                    FFAppState().nonePackageImageFrontUploaded = '';
                                                                                    FFAppState().nonePackageImageRightFrontUploaded = '';
                                                                                    FFAppState().nonePackageImageRightUploaded = '';
                        ...
                        Column(
                          ...
                          children: [
                            if ((FFAppState().profileLevel != 'HO') ||
                                tabBarAuthorizationRecord!.employeeIdList
                                    .contains(FFAppState().employeeID))
                              Expanded(
                                child: Column(
                                  mainAxisSize: MainAxisSize.max,
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            if (((_model.checkRenewAPIOutput?.statusCode ??
                                        200) ==
                                    200) &&
                            ...
                            if (true ||
                                (((_model.checkRenewAPIOutput?.statusCode ??
                                            200) ==
                                        200) &&
                                    (RenewCheckRenewCall.statuslayer1(
                                          (_model.checkRenewAPIOutput
