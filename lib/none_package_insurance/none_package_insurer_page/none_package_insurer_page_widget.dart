...
class _NonePackageInsurerPageWidgetState
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<InsurerConfig2Record>(
      future: InsurerConfig2Record.getDocumentOnce(
          FFAppState().insurerConfig2InactiveInsurer!),
                                                                  ...
                                                                  setState(() {
                                                                    FFAppState().nonePackageInsurerSelectedList = functions
                                                                        .setBoolValueListAtIndex(
                                                                            functions.createFalseListByItemNumber(false, FFAppState().nonePackageInsurerNameList.length)?.toList(),
                                                                            dataListIndex)!
                                                                        .toList()
                                                                        .cast<bool>();
                                                                  });
                                      ...
                                      if (InsuranceRequestSendEmailAPICall
                                        ...
                                        setState(() {
                                          ...
                                          FFAppState().nonePackageFlagAct =
                                              true;
                                          FFAppState()
                                              .nonePackageIsBrandSelect = false;
                                          FFAppState()
