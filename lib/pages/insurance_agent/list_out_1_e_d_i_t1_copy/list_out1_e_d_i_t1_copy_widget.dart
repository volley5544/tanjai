...
import 'list_out1_e_d_i_t1_copy_model.dart';
export 'list_out1_e_d_i_t1_copy_model.dart';

class ListOut1EDIT1CopyWidget extends StatefulWidget {
  const ListOut1EDIT1CopyWidget({Key? key}) : super(key: key);

  @override
  _ListOut1EDIT1CopyWidgetState createState() =>
      _ListOut1EDIT1CopyWidgetState();
}

class _ListOut1EDIT1CopyWidgetState extends State<ListOut1EDIT1CopyWidget> {
  late ListOut1EDIT1CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListOut1EDIT1CopyModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'List_out_1_EDIT1Copy'});
    // On page load action.
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<UrlLinkStorageRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UrlLinkStorageRecord> listOut1EDIT1CopyUrlLinkStorageRecordList =
            snapshot.data!;
        final listOut1EDIT1CopyUrlLinkStorageRecord =
            listOut1EDIT1CopyUrlLinkStorageRecordList.isNotEmpty
                ? listOut1EDIT1CopyUrlLinkStorageRecordList.first
                : null;
