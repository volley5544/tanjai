...
import 'gemini_page_model.dart';
export 'gemini_page_model.dart';
...
class _GeminiPageWidgetState extends State<GeminiPageWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GeminiPageModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'GeminiPage'});
