...
import 'fire_quotation_copy_model.dart';
export 'fire_quotation_copy_model.dart';

class FireQuotationCopyWidget extends StatefulWidget {
  const FireQuotationCopyWidget({
    super.key,
...
class _FireQuotationCopyWidgetState extends State<FireQuotationCopyWidget> {
  late FireQuotationCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FireQuotationCopyModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'FireQuotationCopy'});
    // On page load action.
