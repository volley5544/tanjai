...
import 'fire_insurer_list_all_model.dart';
export 'fire_insurer_list_all_model.dart';

class FireInsurerListAllWidget extends StatefulWidget {
  const FireInsurerListAllWidget({
    super.key,
    this.brandCode,
    this.modelCode,
    this.year,
  ...
  State<FireInsurerListAllWidget> createState() =>
      _FireInsurerListAllWidgetState();
}

class _FireInsurerListAllWidgetState extends State<FireInsurerListAllWidget>
    with TickerProviderStateMixin {
  late FireInsurerListAllModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FireInsurerListAllModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'fireInsurerListAll'});
    // On page load action.
