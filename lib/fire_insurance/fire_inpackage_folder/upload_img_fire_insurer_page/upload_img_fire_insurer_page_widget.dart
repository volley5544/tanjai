...
import 'upload_img_fire_insurer_page_model.dart';
export 'upload_img_fire_insurer_page_model.dart';

class UploadImgFireInsurerPageWidget extends StatefulWidget {
  const UploadImgFireInsurerPageWidget({
    super.key,
    String? titleText,
  ...
  static String routeName = 'uploadImgFireInsurerPage';
  static String routePath = 'uploadImgFireInsurerPage';

  @override
  State<UploadImgFireInsurerPageWidget> createState() =>
      _UploadImgFireInsurerPageWidgetState();
}

class _UploadImgFireInsurerPageWidgetState
    extends State<UploadImgFireInsurerPageWidget> {
  late UploadImgFireInsurerPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UploadImgFireInsurerPageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'uploadImgFireInsurerPage'});
    // On page load action.
