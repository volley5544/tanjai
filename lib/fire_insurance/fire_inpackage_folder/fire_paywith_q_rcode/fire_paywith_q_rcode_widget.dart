...
import 'fire_paywith_q_rcode_model.dart';
export 'fire_paywith_q_rcode_model.dart';

class FirePaywithQRcodeWidget extends StatefulWidget {
  const FirePaywithQRcodeWidget({
    super.key,
    this.taxId,
    this.suffix,
    this.ref1,
...
class _FirePaywithQRcodeWidgetState extends State<FirePaywithQRcodeWidget> {
  late FirePaywithQRcodeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FirePaywithQRcodeModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'firePaywithQRcode'});
    // On page load action.
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<UrlLinkStorageRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UrlLinkStorageRecord> firePaywithQRcodeUrlLinkStorageRecordList =
            snapshot.data!;
        final firePaywithQRcodeUrlLinkStorageRecord =
            firePaywithQRcodeUrlLinkStorageRecordList.isNotEmpty
                ? firePaywithQRcodeUrlLinkStorageRecordList.first
                : null;
