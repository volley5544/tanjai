...
import 'fire_insurance_info_page42_model.dart';
export 'fire_insurance_info_page42_model.dart';

class FireInsuranceInfoPage42Widget extends StatefulWidget {
  const FireInsuranceInfoPage42Widget({
    super.key,
    this.quotationId,
    this.leadDetailId,
  });
  ...
  static String routeName = 'fireInsuranceInfoPage4_2';
  static String routePath = 'fireInsuranceInfoPage4_2';

  @override
  State<FireInsuranceInfoPage42Widget> createState() =>
      _FireInsuranceInfoPage42WidgetState();
}

class _FireInsuranceInfoPage42WidgetState
    extends State<FireInsuranceInfoPage42Widget> {
  late FireInsuranceInfoPage42Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FireInsuranceInfoPage42Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'fireInsuranceInfoPage4_2'});
    // On page load action.
