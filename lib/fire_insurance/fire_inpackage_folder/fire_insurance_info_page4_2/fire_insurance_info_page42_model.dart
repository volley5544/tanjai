...
class FireInsuranceInfoPage42Model
    extends FlutterFlowModel<FireInsuranceInfoPage42Widget> {
  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Backend Call - API (insuranceRequestGetInsurerAPI)] action in fireInsuranceInfoPage4_2 widget.
  ApiCallResponse? getInsurer;
  // Stores action output result for [Backend Call - API (ibsApplicationsDetail)] action in fireInsuranceInfoPage4_2 widget.
  ApiCallResponse? ibsDetailAPIOutput;
  // Stores action output result for [Backend Call - API (ibsCalculateInstallment)] action in fireInsuranceInfoPage4_2 widget.
