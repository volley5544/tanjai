...
import 'fire_insurance_info_page5_model.dart';
export 'fire_insurance_info_page5_model.dart';

class FireInsuranceInfoPage5Widget extends StatefulWidget {
  const FireInsuranceInfoPage5Widget({
    super.key,
  ...
  State<FireInsuranceInfoPage5Widget> createState() =>
      _FireInsuranceInfoPage5WidgetState();
}

class _FireInsuranceInfoPage5WidgetState
    extends State<FireInsuranceInfoPage5Widget> with TickerProviderStateMixin {
  late FireInsuranceInfoPage5Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FireInsuranceInfoPage5Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'fireInsuranceInfoPage5'});
    // On page load action.
        ...
        child: Scaffold(
          ...
          body: SafeArea(
            ...
            child: Padding(
              ...
              child: FutureBuilder<List<RoleMenuRecord>>(
                                            ...
                                            children: [
                                              if ((FFAppState()
                                                  ...
                                                  (FFAppState()
                                                      ...
                                                      'พ.ร.บ.') &&
                                                  functions
                                                      .containsValueInDataTypeList(
                                                          columnRoleMenuRecord
                                                              ?.adminRoleGroup
                                                              ?.toList(),
                                                          FFAppState()
                                                              .employeeID,
