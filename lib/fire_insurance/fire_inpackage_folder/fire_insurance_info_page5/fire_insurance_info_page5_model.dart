...
import 'fire_insurance_info_page5_widget.dart'
...
class FireInsuranceInfoPage5Model
    extends FlutterFlowModel<FireInsuranceInfoPage5Widget> {
  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Backend Call - API (getDateTimeAPI)] action in fireInsuranceInfoPage5 widget.
  ApiCallResponse? getDateTimeOutput;
  // Stores action output result for [Backend Call - API (ibsApplicationsDetail)] action in fireInsuranceInfoPage5 widget.
  ApiCallResponse? applicationDetailOutput;
  // Stores action output result for [Backend Call - API (getInsurancePolicyApi)] action in fireInsuranceInfoPage5 widget.
