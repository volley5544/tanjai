...
import 'fire_insurance_info_page1_model.dart';
export 'fire_insurance_info_page1_model.dart';

class FireInsuranceInfoPage1Widget extends StatefulWidget {
  const FireInsuranceInfoPage1Widget({
    super.key,
    this.quotationId,
    this.leadDtailId,
  });
  ...
  State<FireInsuranceInfoPage1Widget> createState() =>
      _FireInsuranceInfoPage1WidgetState();
}

class _FireInsuranceInfoPage1WidgetState
    extends State<FireInsuranceInfoPage1Widget> with TickerProviderStateMixin {
  late FireInsuranceInfoPage1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FireInsuranceInfoPage1Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'fireInsuranceInfoPage1'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      FFAppState().insuranceInfoPage4FileCancelLoan =
          '${IbsApplicationsDetailCall.filecancelloan(
        (_model.detailAPIOutput?.jsonBody ?? ''),
      )}';
      FFAppState().InsuranceInfoPage4PowerOfAttoney =
          '${IbsApplicationsDetailCall.powerofattorney(
        (_model.detailAPIOutput?.jsonBody ?? ''),
      )}';
