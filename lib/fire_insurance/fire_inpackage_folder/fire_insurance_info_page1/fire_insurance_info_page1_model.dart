...
import 'fire_insurance_info_page1_widget.dart'
...
class FireInsuranceInfoPage1Model
    extends FlutterFlowModel<FireInsuranceInfoPage1Widget> {
  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Backend Call - API (GetLicenseList)] action in fireInsuranceInfoPage1 widget.
  ApiCallResponse? getLicenseAPIOutoutCopy;
  // Stores action output result for [Backend Call - API (GetOccupation)] action in fireInsuranceInfoPage1 widget.
  ApiCallResponse? getOccuAPIOutput;
  // Stores action output result for [Backend Call - API (ibsApplicationsDetail)] action in fireInsuranceInfoPage1 widget.
  ApiCallResponse? detailAPIOutput;
  // Stores action output result for [Backend Call - API (getProfileImage)] action in fireInsuranceInfoPage1 widget.
