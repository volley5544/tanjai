                                                                      ...
                                                                      Builder(
                                                                        builder:
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            _shouldSetState =
                                                                                true;
                                                                            if ((_model.getFileVmiButton?.statusCode ?? 200) !=
                                                                                200) {
                                                                              await showDialog(
                                                                                context: context,
                                                                                builder: (alertDialogContext) {
                                                                      ...
                                                                      FFButtonWidget(
                                                                        onPressed:
                                                                          ...
                                                                          var _shouldSetState =
                                                                              false;
                                                                          _model.getHistory =
                                                                              await GetNonePackageHistoryAPICall.call(
                                                                            token:
                                                                          ...
                                                                          _shouldSetState =
                                                                              true;
                                                                          if ((_model.getHistory?.statusCode ?? 200) !=
                                                                              200) {
                                                                            await showDialog(
                                                                              context: context,
                                                                              builder: (alertDialogContext) {
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return WebViewAware(
                                                                          child:
                                                                              AlertDialog(
                                                                            title:
                                                                                Text('ไม่พบไฟล์ในระบบ'),
                                                                            content:
                                                                                Text('กรุณารอทางทีมประกันเพิ่มข้อมูลในระบบ'),
                                                                            actions: [
                                                                              TextButton(
                                                                                onPressed: () => Navigator.pop(alertDialogContext),
                                                                                child: Text('Ok'),
