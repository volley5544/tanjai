...
import '/index.dart';
import 'make_fire_insurance_list_page_widget.dart'
...
class MakeFireInsuranceListPageModel
    extends FlutterFlowModel<MakeFireInsuranceListPageWidget> {
  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Custom Action - getBuildVersion1] action in MakeFireInsuranceListPage widget.
  String? getBuildVersion;
  // Stores action output result for [Custom Action - getBuildNumber] action in MakeFireInsuranceListPage widget.
  int? deviceBuildNumber;
  // Stores action output result for [Firestore Query - Query a collection] action in MakeFireInsuranceListPage widget.
