...
class SearchPackageFireInsurancePageModel
  ...
  // Stores action output result for [Backend Call - Read Document] action in SearchPackageFireInsurancePage widget.
  KeyStorageRecord? queryApiUrlProdOutput;
  // Stores action output result for [Backend Call - Read Document] action in SearchPackageFireInsurancePage widget.
  KeyStorage3Record? queryApiUrlUatOutput;
